...
import { handleInteractionError } from "../errors";
...
export class Button {
  public static registry = new Map<string, Button>();
  ...
  public build(customId?: string) {
    const newBuilder = ButtonBuilder.from(this.builder);
